...
public class ArrayUtilsTest {
    ...
    private static Stream<Arguments> expectedParametersProviderForGetArrayAfterDigit() {
        return Stream.of(
                ...
                Arguments.arguments(new int[]{4, 2, 4, 3}, new int[]{2}),
    ...
    void shouldReturnTrueCheckDigitsInArray(int[] parameters) {
        Assertions.assertTrue(ArrayUtils.checkDigitsInArray(parameters, 1, 4));
    }
    ...
    void shouldReturnFalseCheckDigitsInArray(int[] parameters) {
        Assertions.assertFalse(ArrayUtils.checkDigitsInArray(parameters, 1, 4));
    }
